...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'teacher', 'course-creator', 'examiner'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Modules', path: '/modules', entity: 'module', service: AccessServiceEnum.PROJECT, icon: FiFileText },
