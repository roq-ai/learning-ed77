  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover, Engage, and Excel with Learning: Your Online Portal for Module-wise Learning, Exams, and Certification. No Hidden Fees, Pure Knowledge."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1610484826967-09c5720778c7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxvbmxpbmUlMjBsZWFybmluZ3xlbnwwfHx8fDE2OTMyMzE2ODJ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@comparefibre?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Compare Fibre`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover, Engage, and Excel with Learning: Your Online Portal for Module-wise Learning, Exams, and Certification. No Hidden Fees, Pure Knowledge.`}
            </Text>
            <Box
