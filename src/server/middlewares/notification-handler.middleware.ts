...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'course.create': {
    roles: ['administrator', 'teacher', 'examiner'],
  ...
  'exam.create': {
    roles: ['administrator', 'teacher', 'examiner'],
    key: 'new-exam-created',
    tenantPath: ['organization', 'course', 'exam'],
    userPath: [],
  },
  'exam.update': {
    roles: ['administrator', 'teacher', 'examiner'],
  ...
  'certificate.create': {
    roles: ['administrator', 'teacher', 'examiner'],
    key: 'new-certificate-issued',
    tenantPath: ['organization', 'course', 'exam', 'certificate'],
    userPath: [],
  },
  'user.create': {
    roles: ['administrator'],
...
const tenantRoles: string[] = ['administrator', 'teacher', 'course-creator', 'examiner'];
